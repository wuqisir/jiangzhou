...
class Data(object):
    def __init__(self, path, batch_size):
        ...
        self.exist_users = []
        # self.test_matrix = np.load(f"./dataset/{args.dataset}/{args.dataset}_test.npy")
    ...
    def get_adj_mat(self):
        try:
            ...
            print(self.path  + 's_norm_adj_mat.npz')

        except Exception:
            print("creat adj matrix")
    ...
    def sample(self):
        ...
        for u in users:
            ...
            neg_items += sample_neg_items_for_u(u, args.neg_ratio)
            # 调了负样本比例
